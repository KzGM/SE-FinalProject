...
namespace ShopTestSE.Controllers
{
    public class PaymentTypesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "PaymentTypeID,Type")] PaymentType paymentType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "PaymentTypeID,Type")] PaymentType paymentType)
        {
            if (ModelState.IsValid)
            {
